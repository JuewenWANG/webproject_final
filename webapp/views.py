...
def difficulties(request):
    try:
        ...
        try:
            ...
            return render(request, 'test/error.html', {"reason":"Difficulté n'existe pas!"})
...
def detail(request):
    try:
        ...
        try:
            ...
            return render(request, 'test/error.html', {"reason":"Technologie n'existe pas!"})
    ...
    return render(request, 'test/detail.html', locals())
    ...
    try:
        if request.method == 'POST':
            ...
            if reg_form.is_valid():
                ...
                return render(request,'test/error.html',{'reason': reg_form.errors})
        else:
            reg_form = RegForm()
    except Exception as e:
        logger.error(e)
        ...
        if request.method == 'POST':
            ...
            if login_form.is_valid():
                ...
                if user is not None:
                    ...
                    return render(request,'test/error.html',{'reason': 'un erreur est produit'})
                return redirect(request.POST.get('source_url'))
            else:
                return render(request, 'test/error.html', {'reason': login_form.errors})
        else:
            login_form = LoginForm()
    except Exception as e:
        logger.error(e)
...
def subform(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            return render(request, "test/subform.html", {'form': form, 'success': 1})

        else:
            return render(request, "test/subform.html", {'form': form, 'success': 0})
...
def contact(request):
    ...
    return render_to_response("test/contact.html")
############################################################################################
@authenticated_view
def view_cart(request):
    cart = request.session.get(request.user.id, None)
    return render(request, 'test/checkout.html', locals())
